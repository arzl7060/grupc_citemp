    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
        <a href="<?= base_url('Produk') ?>" class="nav-link <?= ($subtitle == 'produk') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p>Product</p>
        </a>
        </li>
        <li class="nav-item">
        <a href="<?= base_url('Kategori') ?>" class="nav-link <?= ($subtitle == 'kategori') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p>Kategori</p>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= base_url('User') ?>" class="nav-link <?= ($subtitle == 'user') ? 'active' : '' ?>">
            <i class="far fa-circle nav-icon"></i>
            <p>User</p>
        </a>
    </li>
